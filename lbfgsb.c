...
/* Stephen: trying to make compatible for Windows.
 In this case, we don't want the underscores, so I am using
 macros to detect this. */
#if !defined(_WIN32)
#define dcopy dcopy_
#define dscal dscal_
#define ddot ddot_
	...
	task_len, ftnlen csave_len)
{
    ...
    extern /* Subroutine */ int freev_(integer *, integer *, integer *, 
	    ...
	    logical *, integer *, integer *), dcopy(integer *, doublereal *, 
	    integer *, doublereal *, integer *);
    static doublereal dnorm;
#ifdef USE_TIMER
    extern int timer(doublereal *), formk_(integer *, 
	...
	integer *head, integer *info)
{
    ...
    extern /* Subroutine */ int dpofa_(doublereal *, integer *, integer *, 
	    integer *), dcopy(integer *, doublereal *, integer *, doublereal 
